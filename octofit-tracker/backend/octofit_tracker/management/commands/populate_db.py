...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create Workouts
        workouts = [
            Workout.objects.create(name='Strength Training', description='Full body workout', suggested_for_team=marvel),
            Workout.objects.create(name='Cardio Blast', description='High intensity cardio', suggested_for_team=dc),
        ]
